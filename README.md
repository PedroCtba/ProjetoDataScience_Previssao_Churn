...
O número de clientes perdidos está patamar record, como cientista de dados devo verificar a causa do problema e transformar a solução em uma solução de DataScience.
...
Antes mesmo de ir para a análise exploratória eu gosto de observar como está o balanço da base, isso traz mais inteligência para os insights.
Além disso, classes desbalanceadas podem enviesar bastante a percepção de assertividade de um modelo;
...
Algo importante para ser reparado foi que os "top 5" balanços do banco entraram em "churn", portanto isso é um indicativo inicial de cuidado com essa categoria de clientes.

## EDA:

A primeira variável que quero destacar nessa fase é a idade, como é possível ver pelas distribuições a classe de cima "1" é bem mais velha que a classe de baixo "0".

Portanto, clientes mais velhos estão deixando mais o banco

![image](https://user-images.githubusercontent.com/85971408/129574296-68b7a0c4-b42d-4c04-89de-28e940acae20.png)

Outro fator importante à ser elencado também é o "CreditScore" onde a distribuição de Scores na classe que saiu é mais "homogênea"
...
- Transformação de categóricos em numéricos.
...
Gosto de rodar esse algorítimo primeiro, consigo além de ter um resultado inicial observar as "features importances" oque traz ganho de informação para os próximos algorítimos.
...
Aqui é feito uma listagem dos parâmetros possíveis para os algorítimos e testados diferentes combinações de parâmetros, os melhores resultados para cada algorítimo vieram dos parâmetros:
...
Aqui são testados os algorítimos com os padrões melhorados, e com várias combinações diferentes de treino e teste, depois os resultados são colocados em um DataFrame para serem avaliados comparativamente
...
# Teste de hipótese:
Agora verificamos se entre os algorítimos há uma diferença significativa de desempenho
